...
class GetPlaceByLatLng extends UseCases<PlaceSearch, Map<String, dynamic>> {
  final HomeRepository repository;

  GetPlaceByLatLng({required this.repository});
  @override
  Future<Either<String, PlaceSearch>> call(params) async{
    return await  repository.getPlaceByLatLng(params);
  }
}
